...
import MockSectionSvg from './assets/ce-header-banner-mock-section.svg';
import BannerBars from './assets/Vector.png';
...
type CeHeaderBannerMockSectionProps = {
  moduleName?: string;
...
export const Component = (props: CeHeaderBannerMockSectionProps) => {
  const {
    moduleName,
  ...
  return (
    <Div className="customer-engagement-page">
      <Section
        className="mock-section ce-header-banner-mock"
        aria-label={mockSectionAriaLabel || 'Product preview'}
        data-hs-token={getDataHSToken(moduleName, 'mockSectionAriaLabel')}
      >
        <Img className="ce-header-banner-mock__bars" src={BannerBars} alt="" aria-hidden="true" decoding="async" />

        <Div className="container">
          <Div className="ce-header-banner-mock__content" aria-label="Banner content">
            <H1 className="ce-header-banner-mock__headline">
              Fewer Calls. Better Enrollment.
              <br />
              Customers Who Actually Engage.
            </H1>
            <P className="ce-header-banner-mock__subcopy">
              Most CX platforms know what your customers did. Bidgely knows why, down to the appliance.
              <br />
              That's the difference between a generic alert and one that changes behavior.
            </P>
            <Div className="ce-header-banner-mock__cta">
              <A className="ce-header-banner-mock__cta-btn" href="#talk-to-an-expert">
                Talk to an Expert
              </A>
            </Div>
          </Div>
                ...
                <Div className="mock-window__main">
                  ...
                  <Div className="appliance-list">
                    {groupApplianceRows.map((row, index) => {
                      ...
                      const imgLoading = icon?.loading && icon.loading !== 'disabled' ? icon.loading : 'eager';
                      return (
...
export const meta: ModuleMeta = {
  label: 'Customer Engagement — header banner mock',
...
export const defaultModuleConfig = {
  moduleName: 'elevate/components/modules/ce_header_banner_mock_section',
  version: 1,
  themeModule: true,
};
